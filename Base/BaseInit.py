...
def init(devices):
    ...
    print(PATH("../app/appium-uiautomator2-server-v0.1.9.apk"))
    os.popen("adb -s %s install -r %s" % (devices, PATH("/01code_relevant/Automator_SZ_Support/app/appium-uiautomator2-server-v0.1.9.apk")))
    os.popen("adb -s %s install -r %s" % (devices, PATH("/01code_relevant/Automator_SZ_Support/appium-uiautomator2-server-debug-androidTest.apk")))
